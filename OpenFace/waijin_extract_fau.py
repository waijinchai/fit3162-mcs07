...
# set the directories
input_dir = "C:/Users/User/Desktop/MonashDocuments/FIT3162/Repo/fit3162-mcs07/OpenFace/input_videos"   # directory of where the videos are
output_dir = "C:/Users/User/Desktop/MonashDocuments/FIT3162/Repo/fit3162-mcs07/OpenFace/output"  # directory to output the csv file
...
def extract_fau(input_video) -> pd.DataFrame:
    ...
    df = pd.read_csv(f"C:/Users/User/Desktop/MonashDocuments/FIT3162/Repo/fit3162-mcs07/OpenFace/output/{input_vid_name}.csv")  
